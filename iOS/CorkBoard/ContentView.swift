...
struct ContentView: View {
    @EnvironmentObject var store: CorkBoardStore
    ...
    @ViewBuilder
    private func row(for entry: BottleEntry) -> some View {
        HStack {
        ...
        NavigationStack {
            Form {
                Section("Bottle") {
                    ...
                    TextField("Vintage / Region", text: $detail)
                        .accessibilityIdentifier("entryDetailField")
                    DatePicker("Drink By", selection: $date, displayedComponents: .date)
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        var entry = existing ?? BottleEntry(name: name, detail: detail, date: date)
                        entry.name = name
                        entry.detail = detail
                        entry.date = date
