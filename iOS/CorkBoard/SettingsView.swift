...
struct SettingsView: View {
    ...
    @AppStorage("corkboard_notify_enabled") private var notifyEnabled: Bool = true
    @AppStorage("corkboard_favorites_only") private var favoritesOnly: Bool = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/corkboard-app/privacy.html")!)
